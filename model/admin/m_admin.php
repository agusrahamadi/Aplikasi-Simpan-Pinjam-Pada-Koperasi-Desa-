<?php
	class m_admin{
		...
		public function update($id,$password,$nama,$status){

			return mysql_query("UPDATE $this->table SET  password = '$password', nama_admin = '$nama', status = '$status' WHERE $this->id = '$id'");
