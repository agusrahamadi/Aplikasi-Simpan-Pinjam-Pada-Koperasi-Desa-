<?php
	class m_simpan{
		...
		public function select(){
			...
			return mysql_query("SELECT * FROM $this->table, anggota, admin WHERE $this->table.id_anggota = anggota.id_anggota AND $this->table.username = admin.username ORDER BY $this->table.id_simpan DESC");
