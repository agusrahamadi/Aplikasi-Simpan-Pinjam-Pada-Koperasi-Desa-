<?php
	class m_peminjaman_a{
		...
		public function select($id){
			...
			return mysql_query("SELECT $this->table.* ,anggota.nama FROM anggota, $this->table WHERE anggota.id_anggota = $this->table.id_anggota AND $this->table.id_peminjaman_a = '$id'");
