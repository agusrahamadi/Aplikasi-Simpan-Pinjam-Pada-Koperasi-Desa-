						...
						<div class="login-container">
							<div class="center">
								<h1>
									<i class=""></i>
									<span class="red"></span>
									<span class="white" id="id-text2">Aplikasi Simpan Pinjam Pada Koperasi Unit Desa Penurus Baru</span>
								</h1>
								<h4 class="blue" id="id-company-text">Halaman Anggota</h4>
							</div>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="id" class="form-control" placeholder="Id Aanggota" />
