<?php
	...
	$anggota=$this->where("anggota","id_anggota","$_SESSION[id]");
	$peminjaman_a=$this->where("peminjaman_a","id_anggota","$_SESSION[id]");
?>
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<li class="<?php if(isset($_GET['mod'])){if($_GET['mod']=='peminjaman_a'){ echo 'active';}}?>">
						...
						<ul class="submenu">
							<?php while ($data=mysql_fetch_array($peminjaman_a)) { ?>
							<li class="">
								<a href="?mod=peminjaman_a&id=<?php echo $data['id_peminjaman_a'] ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									<?php echo $data['id_peminjaman_a'] ?>
								</a>
					...
					<?php while ($data=mysql_fetch_array($anggota)) { ?>
						<li class="<?php if(isset($_GET['mod'])){if($_GET['mod']=='profile'){ echo 'active';}}?>">
						<a href="?mod=admin&id_anggota=<?php echo $data['id_anggota'] ?>">
