...
<page>
        ...
        $qupdate = "SELECT * FROM angsuran, anggota, admin WHERE angsuran.id_anggota = anggota.id_anggota AND angsuran.username = admin.username AND angsuran.id_angsuran ='$id_angsuran' ";
        $rupdate = mysqli_query($mysqli, $qupdate);
        while($dupdate = mysqli_fetch_assoc($rupdate)){
			
       		?>
		
		<h5 align="center">BUKTI TRANSAKSI ANGSURAN PINJAMAN DANA</h5>
		 <table border="0"   style="font-size:12px;" cellspacing="3" cellpadding="3">
       <tr>
        <td width="40" align="rigth"></td>
        <td width="410" colspan="4">Pada Tanggal  <?php echo $dupdate['tgl_angsuran']; ?> :</td>  
     ...
     <tr>
      ...
      <tr>
        <td width="40" align="rigth"></td>
        <td width="410" colspan="4">Telah Melakukan Transaksi Pembayar Peminjman Dana ke <?php echo $dupdate['angsuran_ke']; ?> Yaitu :</td>  
      </tr>
