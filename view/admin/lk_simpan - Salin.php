...
<page>
        ...
        while($dupdate = mysqli_fetch_assoc($rupdate)){
       		...
       		?>
		<h5 align="center">KWITANSI TABUNGAN</h5>
     ...
     <tr>
      ...
      <tr>
		...
		<table  border="1" align="center" style="font-size: 10px; border-collapse: collapse; width: 100%;">
			...
			<tbody>
<tr>
<td style="width:60px;" align="center">&nbsp;Rp. <?php echo  number_format($dupdate['kridit_anggota'],0); ?>&nbsp;</td>
<td style="width:60px;" align="center">&nbsp;Rp. <?php echo  number_format($dupdate['debet_anggota'],0); ?>&nbsp;</td>
<td style="width:60px;" align="center">&nbsp;Rp. <?php echo  number_format($dupdate['saldo_anggota'],0); ?>&nbsp;</td>
</tr>
</tbody>
...
<table border="0"   style="font-size:10px; cellspacing="3" cellpadding="3">
	...
	<table border="0"   style="font-size:10px; cellspacing="3" cellpadding="3">
			...
			<tr>
				<td width="40" align="rigth"></td>
				<td width="300" style="font-size:7px;" >1. VERIFIED artinya surat sudah terferivikasi oleh admin dan terferivikasi juga dari yang memberikan peryataan pada.</td>
			</tr>
			<tr>
				<td width="40" align="rigth"></td>
				<td width="300" style="font-size:7px;" >2. Kwitansi ini diberikan secara otomatis oleh sistem aplikasi.</td>
			</tr>
