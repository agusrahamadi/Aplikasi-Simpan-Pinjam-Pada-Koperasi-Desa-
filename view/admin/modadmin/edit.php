...
<?php
	...
	if (isset($_POST['update'])) {
		...
		if ($_POST['update']=="update") {
			...
			$admin->update($_POST['username'],md5($_POST['password']),strtoupper($_POST['nama_admin']),$_POST['status']);
		...
		<form method="post" action="?mod=admin&aksi=edit">
			<table class="table table-striped table-bordered table-hover">
				...
				<tr>
					<td>Kata Sandi</td>
					<td><input type="text" name="password" placeholder="Kata Sandi" required value="<?php echo md5($row['password']) ?>" class="col-md-12"></td>
				</tr>
