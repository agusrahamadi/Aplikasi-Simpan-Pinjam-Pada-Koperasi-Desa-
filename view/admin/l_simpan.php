...
<page>
		...
		<hr>
		<h5 align="center">LAPORAN DATA TABUNGAN</h5>
        ...
        $qupdate = "SELECT * FROM simpan, anggota, admin WHERE simpan.id_anggota = anggota.id_anggota AND simpan.username = admin.username ";
...
<td style="width:50px;" align="center">&nbsp;<?php echo $dupdate['tgl_simpan']; ?>&nbsp;</td>
