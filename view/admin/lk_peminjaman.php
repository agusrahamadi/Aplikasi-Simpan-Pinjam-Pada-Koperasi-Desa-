...
<page>
        ...
        $qupdate = "SELECT * FROM peminjaman, anggota, admin WHERE peminjaman.id_anggota = anggota.id_anggota AND peminjaman.username = admin.username AND peminjaman.id_peminjaman ='$id_peminjaman' ";
        $rupdate = mysqli_query($mysqli, $qupdate);
        while($dupdate = mysqli_fetch_assoc($rupdate)){
			
       		?>
		
		<h5 align="center">BUKTI TRANSAKSI PEMINJAMAN DANA</h5>
		 <table border="0"   style="font-size:12px;" cellspacing="3" cellpadding="3">
       <tr>
        <td width="40" align="rigth"></td>
        <td width="410" colspan="4">Pada Tanggal  <?php echo $dupdate['tgl_peminjaman']; ?> :</td>  
	   ...
	   <tr>
        ...
        <td width="10">:</td>
        <td width="150"><?php echo $dupdate['id_peminjaman']; ?></td>
      </tr>
	   <tr>
        <td width="40" align="rigth"></td>
        <td width="200"> </td>
     ...
     <tr>
      ...
      <tr>
        <td width="40" align="rigth"></td>
        <td width="410" colspan="4">Telah Melakukan Peminjman Dana : </td>  
      </tr>
      ...
      <tr>
        ...
        <td width="10">:</td>
        <td width="150">Rp. <?php echo  number_format($dupdate['peminjaman'],0); ?></td>
      </tr>
      ...
      <tr>
        ...
        <td width="10">:</td>
        <td width="150"><?php echo $dupdate['cicilan']; ?></td>
      </tr>
	  <tr>
        <td width="40" align="rigth"></td>
        <td width="200"> </td>
      ...
      <tr>
        ...
        <td width="10">:</td>
        <td width="150">Rp. <?php echo  number_format($dupdate['perbulan'],0); ?></td>
      </tr>
