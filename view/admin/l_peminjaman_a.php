...
<page>
        ...
        $qupdate = "SELECT * FROM peminjaman_a, anggota, admin WHERE peminjaman_a.id_anggota = anggota.id_anggota AND peminjaman_a.username = admin.username ";
        $rupdate = mysqli_query($mysqli, $qupdate);
        while($dupdate = mysqli_fetch_assoc($rupdate)){
            
            $a= $dupdate["cicilan_a"] - 4 ;
			
       		?>
			<tbody>
<tr>
<td align="center">&nbsp;<?php echo $no ?>&nbsp;</td>
<td style="width:50px;" align="center">&nbsp;<?php echo $dupdate['id_peminjaman_a']; ?>&nbsp;</td>
<td style="width:130px;" >&nbsp;<?php echo $dupdate['nama']; ?>&nbsp;</td>
<td style="width:60px;" >&nbsp;<?php echo $dupdate['nama_a']; ?>&nbsp;</td>
<td style="width:60px;" >&nbsp;<?php echo $dupdate['merek']; ?>/<?php echo $dupdate['type']; ?>&nbsp;</td>
<td style="width:60px;" align="center">&nbsp;Rp. <?php echo  number_format($dupdate['peminjaman_a'],0); ?>&nbsp;</td>
<td style="width:50px;" align="center">&nbsp;<?php echo $dupdate['cicilan_a']; ?>&nbsp;</td>
<td style="width:30px;" align="center">&nbsp;<?php echo $a; ?>&nbsp;</td>
