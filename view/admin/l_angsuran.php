...
<page>
		...
		<hr>
		<h5 align="center">LAPORAN DATA ANGSURAN PINJAMAN DANA</h5>
        ...
        $qupdate = "SELECT * FROM angsuran, anggota, admin WHERE angsuran.id_anggota = anggota.id_anggota AND angsuran.username = admin.username ";
...
<td style="width:50px;" align="center">&nbsp;<?php echo $dupdate['tgl_angsuran']; ?>&nbsp;</td>
<td style="width:80px;" align="center">&nbsp;<?php echo $dupdate['id_peminjaman']; ?>&nbsp;</td>
